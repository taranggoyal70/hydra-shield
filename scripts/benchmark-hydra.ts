...
import { percentileFromSorted } from "../server/evaluation.js";
...
console.log(JSON.stringify({
  ...
  iterations,
  p50Ms: Number(percentileFromSorted(timings, 0.5).toFixed(2)),
  p95Ms: Number(percentileFromSorted(timings, 0.95).toFixed(2)),
